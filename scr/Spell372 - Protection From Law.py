...
def OnBeginSpellCast( spell ):
	print "Protection From Law OnBeginSpellCast"
	print "spell.target_list=", spell.target_list
	print "spell.caster=", spell.caster, " caster.level= ", spell.caster_level
	game.particles( "sp-abjuration-conjure", spell.caster )

def	OnSpellEffect( spell ):
	print "Protection From Law OnSpellEffect"
	...
	if target_item.obj.is_friendly( spell.caster ):
		...
		target_item.partsys_id = game.particles( 'sp-Protection From Law', target_item.obj )
...
def OnBeginRound( spell ):
	print "Protection From Law OnBeginRound"

def OnEndSpellCast( spell ):
	print "Protection From Law OnEndSpellCast"