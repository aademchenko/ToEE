...
def OnBeginSpellCast( spell ):
	print "Cure Critical Wounds OnBeginSpellCast"
	print "spell.target_list=", spell.target_list
	print "spell.caster=", spell.caster, " caster.level= ", spell.caster_level
	game.particles( "sp-conjuration-conjure", spell.caster )

def OnSpellEffect( spell ):
	print "Cure Critical Wounds OnSpellEffect"

	dice = dice_new( "4d8" )
	#dice.bonus = min( 20, spell.caster.stat_level_get( spell.caster_class ) )
	dice.bonus = min( 20, spell.caster_level )
...
def OnBeginRound( spell ):
	print "Cure Critical Wounds OnBeginRound"

def OnEndSpellCast( spell ):
	print "Cure Critical Wounds OnEndSpellCast"