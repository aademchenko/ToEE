...
def OnBeginSpellCast( spell ):
	print "Owl's Wisdom OnBeginSpellCast"
	print "spell.target_list=", spell.target_list
	print "spell.caster=", spell.caster, " caster.level= ", spell.caster_level
	game.particles( "sp-transmutation-conjure", spell.caster )

def	OnSpellEffect( spell ):
	print "Owl's Wisdom OnSpellEffect"
	...
	if target_item.obj.is_friendly( spell.caster ):
		...
		target_item.obj.condition_add_with_args( 'sp-Owls Wisdom', spell.id, spell.duration, str_amount )
...
def OnBeginRound( spell ):
	print "Owl's Wisdom OnBeginRound"

def OnEndSpellCast( spell ):
	print "Owl's Wisdom OnEndSpellCast"