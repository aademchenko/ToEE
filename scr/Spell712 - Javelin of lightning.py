...
def OnSpellEffect( spell ):
	...
	for target_item in spell.target_list:
		...
		if target_item.obj.reflex_save_and_damage( spell.caster, spell.dc, D20_Save_Reduction_Half, D20STD_F_NONE, damage_dice, D20DT_ELECTRICITY, D20DAP_NOT_APPLICABLE, D20A_CAST_SPELL, spell.id ) > 0:
