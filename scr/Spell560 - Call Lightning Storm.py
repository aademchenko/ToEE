...
def OnBeginSpellCast( spell ):
	print "Call Lightning Storm OnBeginSpellCast"
	print "spell.target_list=", spell.target_list
	print "spell.caster=", spell.caster, " caster.level= ", spell.caster_level
	game.particles( "sp-evocation-conjure", spell.caster )

def	OnSpellEffect( spell ):
	print "Call Lightning Storm OnSpellEffect"
	...
	spell.caster.condition_add_with_args( 'sp-Call Lightning Storm', spell.id, spell.duration, (spell.caster_level - 1) )

def OnBeginRound( spell ):
	print "Call Lightning Storm OnBeginRound"

def OnEndSpellCast( spell ):
	print "Call Lightning Storm OnEndSpellCast"
