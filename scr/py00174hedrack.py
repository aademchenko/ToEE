				...
				for pc in game.party:
					if pc.type == obj_t_pc:
						...
						if (game.party[0].stat_level_get(stat_hp_current) >= 1 and game.party[0].d20_query(Q_Prone) == 0):
							...
							game.party[0].begin_dialog( attachee, 190 )
							...
							game.party[1].begin_dialog( attachee, 190 )
							game.global_flags[377] = 1
							return SKIP_DEFAULT
							...
							game.party[2].begin_dialog( attachee, 190 )
							game.global_flags[377] = 1
							return SKIP_DEFAULT
							...
							game.party[3].begin_dialog( attachee, 190 )
							game.global_flags[377] = 1
							return SKIP_DEFAULT
							...
							game.party[4].begin_dialog( attachee, 190 )
							game.global_flags[377] = 1
							return SKIP_DEFAULT
							...
							game.party[5].begin_dialog( attachee, 190 )
							game.global_flags[377] = 1
							return SKIP_DEFAULT
							...
							game.party[6].begin_dialog( attachee, 190 )
							game.global_flags[377] = 1
							return SKIP_DEFAULT
							...
							game.party[7].begin_dialog( attachee, 190 )
							game.global_flags[377] = 1
							return SKIP_DEFAULT
			else:
