...
def OnBeginSpellCast( spell ):
	print "Undeath to Death OnBeginSpellCast"
...
def OnSpellEffect ( spell ):
	print "Undeath to Death OnSpellEffect"
	...
	for target_item in spell.target_list:
		...
		if (obj_hit_dice < 9) and (hit_dice_max >= obj_hit_dice) and (target_item.obj.is_category_type(mc_type_undead)):
...
def OnBeginRound( spell ):
	print "Undeath to Death OnBeginRound"

def OnEndSpellCast( spell ):
	print "Undeath to Death OnEndSpellCast"