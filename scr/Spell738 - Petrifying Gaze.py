...
#	sfile = open("spell_log.txt","a")
#	sfile.write("Petrifying Breath OnBeginSpellCast\n")
#	print >> sfile, "spell.target_list=",spell.target_list
#	print >> sfile, "\nspell.caster= ",spell.caster
#	print >> sfile, " caster.level= ", spell.caster_level
#	sfile.write("\n")
#	sfile.close()
...
#	efile = open("spell_effect_log.txt","a")
#	efile.write("Petrifying Breath OnSpellEffect")
#	efile.write("\n")
