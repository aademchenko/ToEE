...
def OnBeginSpellCast( spell ):
	print "Slay Living OnBeginSpellCast"
	print "spell.target_list=", spell.target_list
	print "spell.caster=", spell.caster, " caster.level= ", spell.caster_level
	game.particles( "sp-necromancy-conjure", spell.caster )

def OnSpellEffect( spell ):
	print "Slay Living OnSpellEffect"

	npc = spell.caster
	if npc.name == 14328:	## Bodak Death Gaze	
		spell.dc = 15

	damage_dice = dice_new( "3d6" )
	damage_dice.bonus = spell.caster.stat_level_get( spell.caster_class )
...
def OnBeginRound( spell ):
	print "Slay Living OnBeginRound"

def OnEndSpellCast( spell ):
	print "Slay Living OnEndSpellCast"