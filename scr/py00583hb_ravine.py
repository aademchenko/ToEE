...
def san_heartbeat( attachee, triggerer ):
	if (attachee.name == 8931):
		...
		if (game.global_flags[553] == 1):
			attachee.standpoint_set( STANDPOINT_NIGHT, 262 )
			attachee.standpoint_set( STANDPOINT_DAY, 262 )
			game.new_sid = 0
	elif (attachee.name == 8965):
		if (game.global_flags[553] == 1):
			attachee.standpoint_set( STANDPOINT_NIGHT, 269 )
			attachee.standpoint_set( STANDPOINT_DAY, 269 )
			game.new_sid = 0
	elif (attachee.name == 8966):
		if (game.global_flags[553] == 1):
		...
		if (game.global_flags[553] == 1):
			attachee.standpoint_set( STANDPOINT_NIGHT, 263 )
			attachee.standpoint_set( STANDPOINT_DAY, 263 )
			game.new_sid = 0
	elif (attachee.name == 8968):
		if (game.global_flags[553] == 1):
			attachee.standpoint_set( STANDPOINT_NIGHT, 268 )
			attachee.standpoint_set( STANDPOINT_DAY, 268 )
			game.new_sid = 0
