...
def OnBeginRound( spell ):
	...
	for obj in game.obj_list_cone( spell.caster, OLC_CRITTERS, spell.range_exact, -45, 90 ):
		...
		if obj.critter_get_alignment() & ALIGNMENT_GOOD:

			# HTN - WIP! check "power"
			game.particles( 'sp-Detect Alignment Good', obj )

def OnEndSpellCast( spell ):
	print "Detect Good OnEndSpellCast"