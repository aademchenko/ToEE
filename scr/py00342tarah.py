...
def dom_mon( attachee, triggerer ):
	...
	game.party[0].condition_add_with_args("Paralyzed",4,0)
	game.party[1].condition_add_with_args("Paralyzed",4,0)
	game.party[2].condition_add_with_args("Paralyzed",4,0)
	game.party[3].condition_add_with_args("Paralyzed",4,0)
	game.party[4].condition_add_with_args("Paralyzed",4,0)
	game.party[5].condition_add_with_args("Paralyzed",4,0)
	game.party[6].condition_add_with_args("Paralyzed",4,0)
	game.party[7].condition_add_with_args("Paralyzed",4,0)
