...
def OnBeginSpellCast( spell ):
	print "Summon Earth Elemental OnBeginSpellCast"
	print "spell.target_list=", spell.target_list
	print "spell.caster=", spell.caster, " caster.level= ", spell.caster_level
	game.particles( "sp-conjuration-conjure", spell.caster )

def	OnSpellEffect( spell ):
	print "Summon Earth Elemental OnSpellEffect"

	spell.duration = 10

	# get the proto_id for this monster 
	monster_proto_id = 14296
	...
	game.particles( 'Orb-Summon-Earth-Elemental', monster_obj )
...
def OnBeginRound( spell ):
	print "Summon Earth Elemental OnBeginRound"

def OnEndSpellCast( spell ):
	print "Summon Earth Elemental OnEndSpellCast"
