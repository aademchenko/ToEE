...
def	OnSpellEffect ( spell ):
	...
	if is_spell_flag_set(target_item.obj, OSF_IS_FLAMING_SPHERE):
		...
		if (target_item.obj.is_category_type( mc_type_elemental )) and (target_item.obj.is_category_subtype( mc_subtype_fire )):
			...
			# no save, full damage
			target_item.obj.spell_damage( spell.caster, D20DT_UNSPECIFIED, damage_dice, D20DAP_UNSPECIFIED, D20A_CAST_SPELL, spell.id )
