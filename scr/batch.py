...
def NighInvulnerable():
	...
	game.party[0].obj_set_int(obj_f_speed_run, 1070353216)
...
def speedup(ec = 1, file_override = -1):
	...
	if ec == 0:
		...
		for pc in game.party[0].group_list():
			if pc.obj_get_int(obj_f_speed_run) != 106535216:
				pc.obj_set_int(obj_f_speed_run, 106535216)
	...
	if ec == 1:
		...
		for pc in game.party[0].group_list():
			if pc.obj_get_int(obj_f_speed_run) != 1070353216:
				pc.obj_set_int(obj_f_speed_run, 1070353216)
				if game.global_flags[403] == 1:
					game.particles( 'Orb-Summon-Air-Elemental', pc )
	if ec == 2:
		for pc in game.party[0].group_list():
			if pc.obj_get_int(obj_f_speed_run) != 1075353216:
				pc.obj_set_int(obj_f_speed_run, 1075353216)
				if game.global_flags[403] == 1:
					game.particles( 'Orb-Summon-Air-Elemental', pc )
	if ec == 3:
		for pc in game.party[0].group_list():
			if pc.obj_get_int(obj_f_speed_run) != 1080353216:
				pc.obj_set_int(obj_f_speed_run, 1080353216)
				if game.global_flags[403] == 1:
					game.particles( 'Orb-Summon-Air-Elemental', pc )
	if ec == 4:
		for pc in game.party[0].group_list():
			if pc.obj_get_int(obj_f_speed_run) != 1090353216:
				pc.obj_set_int(obj_f_speed_run, 1090353216)
				if game.global_flags[403] == 1:
					game.particles( 'Orb-Summon-Air-Elemental', pc )
	if ec == 5:
		# Blazingly fast
		for pc in game.party[0].group_list():
			if pc.obj_get_int(obj_f_speed_run) != 1095353216:
				pc.obj_set_int(obj_f_speed_run, 1095353216)
				if game.global_flags[403] == 1:
					game.particles( 'Orb-Summon-Air-Elemental', pc )
	if ec == 6:
		# Can you say speeding bullet?
		for pc in game.party[0].group_list():
			if pc.obj_get_int(obj_f_speed_run) != 1205353216:
				pc.obj_set_int(obj_f_speed_run, 1205353216)
				if game.global_flags[403] == 1:
					game.particles( 'Orb-Summon-Air-Elemental', pc )
	return