...
def san_dialog( attachee, triggerer ):
	...
	#suggest assassination quests
	elif (game.global_flags[293] == 0 and attachee.has_met(triggerer)):
		...
		if ( assassin_of_lodriss or butcher_of_hommlet or is_friend_of_lareth or ( is_rogue and is_evil ) or (is_beggar_maker and is_evil) ):
