...
def	OnSpellEffect( spell ):
	...
	elif (not target_1.obj.saving_throw_spell( spell.dc, D20_Save_Will, D20STD_F_NONE, spell.caster, spell.id, spell.id ) and target_1.obj.is_friendly( spell.caster ) == 0) or (not target_2.obj.saving_throw_spell( spell.dc, D20_Save_Will, D20STD_F_NONE, spell.caster, spell.id, spell.id ) and target_2.obj.is_friendly( spell.caster ) == 0):
